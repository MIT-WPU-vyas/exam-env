...
class student
{
    ...
    void displayall();
    void deleteRecord();
    void addRecord(); // New function to add records after initial creation
};
...
// New function to add records after initial creation
void student::addRecord()
{
    int hashMethod;
    cout<<"\nSelect hashing method for adding records:";
    ...
    fstream f;
    f.open("student.txt", ios::binary|ios::app|ios::in|ios::out);
    ...
    do
    {
        ...
        if(hashMethod == 1) // Without replacement
        {
            if(h[loc].rollno==-1)
            {
                h[loc].rollno=rec.rollno;
                h[loc].pos=relt;
                f.seekp(0, ios::end); // Move to end of the file
                f.write((char*)&rec, s);
                relt=relt+1;
            }
            else
        ...
        else if(hashMethod == 2) // With replacement
        {
            if(h[loc].rollno==-1)
            {
                h[loc].rollno=rec.rollno;
...
void student::deleteRecord()
{
    ...
    // Note: This is a logical delete. The record still exists in the file
    // but is marked as deleted in the hash table. A full rewrite of the file
    // would be needed to physically remove the record.
}
...
int main()
{
    ...
    do
    {
        ...
        cout<<"\n4. Display a Record";
        cout<<"\n5. Delete a Record";
        cout<<"\n6. Add a Record";  // New menu option
        cout<<"\n7. Exit";          // Updated exit option
        cout<<"\nEnter your choice: ";
        cin>>choice;
        ...
        switch(choice)
        {
            ...
            case 5:
                ...
                break;
            case 6:
                s.addRecord();      // Call to new function
                break;
            case 7:
